...
def define_flags():
    TFLITE_MODEL_FILE_PATH = '../obj_model_training/saved_models/tfLite_mobilenetv3S_flowers.tflite'
    LABELS_PATH = '../obj_model_training/saved_models/labels.txt'
    OUTPUT_PATH = '../obj_model_training/metadata/saved_models'
...
_MODEL_INFO = {
    "tfLite_mobilenetv3L_flowers.tflite":
        ModelSpecificInfo(
            name="Mobilenetv3L image classifier",
            version="v1",
            image_width=180,
            image_height=180,
            image_min=0,
