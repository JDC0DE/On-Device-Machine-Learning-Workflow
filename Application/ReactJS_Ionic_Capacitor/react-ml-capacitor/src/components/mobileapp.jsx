...
export function MobileObjectDetector(props){
    // console.error = () => {};
    ...
    <ParentContainer>
        ...
        <ObjectDetectorContainer>
            ...
            <><DetectorContainer>{display === false ? (imgData && <TargetImg src={imgData} ref={imageRef} />) :
                        (<Webcam audio={false} mirrored={false} height={200} width={200} ref={cameraInput} screenshotFormat="image/jpeg" videoConstraints={videoConstraints} />)}
